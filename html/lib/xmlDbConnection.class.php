...
class xmlDbConnection {
  ...
  function xmlDbConnection($argArray) {
    ...
    // position and quantity - same as tamino/exist position & quantity
    $this->position =& $this->xmldb->position;
    $this->quantity =& $this->xmldb->quantity;
  ...
  function getXqlCursor () {
   ...
   function xslTransform ($xsl_file, $xsl_params = NULL) {
     ...
     // filebase needed for hirerachical structure of greatwar site
