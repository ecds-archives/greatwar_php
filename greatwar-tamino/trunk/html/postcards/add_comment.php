...
print "<html>
  <head>
    $csslink
    <title>The Great War : Postcards : Process Comment</title>
...
if ($mode == "preview") {
  ...
  $fc->display();
  $fc->taminoAdd("user");	// add comment in user mode

  print "<p>Please note: Your comment will not be displayed in the postcard view
until it has been approved by the site administrator.</p>\n";
  
  // link back to the postcard detailed view
  print "<a href='${base_url}postcards/view.php?id=$entity'>Back to Postcard</a><br>\n";
}
